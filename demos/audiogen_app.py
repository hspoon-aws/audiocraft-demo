...
def ui_full(launch_kwargs):
    with gr.Blocks() as interface:
        ...
        gr.Examples(examples=[
                             ...
                             ["Heavy Rain and thunder with wind blowing"],
                             ["racing car, F1, approach and pass"],
                             ["baby is laughing from small to large"],
                             ["baby speaking something you cannot understand"], 
